        ...
        def wrapper(*exec_args, **exec_kwargs):
            ...
            if r.get(lock_key):
                ...
                try:
                    ...
                    _record_task_execution(r, task_name, start, end=timezone.now(), result=result)
...
def _record_task_execution(r, name: str, start, end, result):
    pipe = r.pipeline()
