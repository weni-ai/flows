...
class ClickMobileType(ChannelType):
    ...
    claim_blurb = _(
        "If you're based in Malawi or Ghana, you can purchase a number from %(link)s and connect it in a few steps."
    ...
    configuration_blurb = _(
        "To finish configuring your channel, you'll need to configure Click Mobile to send new messages to the URL below."
    )
