...
class Hub9Type(ChannelType):
    ...
    configuration_urls = (
        dict(
            ...
            description=_(
                "This endpoint should be called by Hub9 when new messages are received at your number. You can set the receive URL on your Hub9 account by contacting your sales agent."
            ),
        ),
        dict(
            ...
            description=_(
                "This endpoint should be called by Hub9 when a message has been delivered to the final recipient (delivery reports). You can set the delivery callback URL on your Hub9 account by contacting your sales agent."
            ),
        ),
    )
