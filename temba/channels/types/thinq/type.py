...
class ThinQType(ChannelType):
    ...
    configuration_blurb = _(
        "To finish configuring your ThinQ connection, set the following callback URLs on the ThinQ website, on the SMS -> SMS Configuration page."
    )
    ...
    configuration_urls = (
        ...
        dict(
            ...
            description=_(
                'Set your delivery confirmation URL to the one above, and select "Form-Data" as the Delivery Notification Format.'
            ),
        ),
    )
