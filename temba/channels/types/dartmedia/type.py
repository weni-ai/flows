...
class DartMediaType(ChannelType):
    ...
    configuration_urls = (
        dict(
            ...
            description=_(
                "This endpoint should be called by Dart Media when new messages are received at your number. You can set the receive URL on your Dart Media account by contacting your sales agent."
            ),
        ),
        dict(
            ...
            description=_(
                "This endpoint should be called by Dart Media when a message has been delivered to the final recipient (delivery reports). You can set the delivery callback URL on your Dart Media account by contacting your sales agent."
            ),
        ),
    )
