...
class FlowsLabelsEndpoint(ListAPIMixin, BaseAPIView):
     ...
     * **project_uuid** - the UUID of the project (string)
     * **parents** - the parent label of the label, if exists
     * **flows** - the flows for this label (array of objects)
            ...
            "results": [
                {
                    "uuid": "5f05311e-8f81-4a67-a5b5-1501b6d6496a",
                    "name": "Survey",
                    "project_uuid": "00d4b5c0-f82f-4214-a20c-86514de16dfa",
                    "parent": null,
                    "flows": [{"name": "Important", "uuid": "5a4eb79e-1b1f-4ae3-8700-09384cca385f"}],
                },
                ...
            ]
        }
