...
BEGIN
    ...
    SET
        -- count S normally, and also count W->D as a send to cover providers that skip S
        sent = sent + CASE
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("msgs", "0169_broadcast_status_trigger"),
    ]

    operations = [
        migrations.RunSQL(OPTIMIZED_TRIGGER_FUNCTION),
        migrations.RunSQL(CREATE_OPTIMIZED_TRIGGER),
    ]
