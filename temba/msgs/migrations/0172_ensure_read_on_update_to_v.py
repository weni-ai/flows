...
# Ensure that 'read' is incremented both on INSERT with status V and on UPDATE to V.
# Delivered semantics remain as in 0171 (no change).
#
# This makes the intent explicit and avoids any ambiguity about updates to V.
...
BEGIN
    ...
    SET
        ...
        -- read must increment on both INSERT V and UPDATE to V
        read = read + CASE
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("msgs", "0171_fix_broadcast_status_trigger_counts"),
    ]
