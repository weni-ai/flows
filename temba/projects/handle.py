...
from .consumers import ProjectConsumer, TemplateTypeConsumer, UpdateProjectConsumer
...
def handle_consumers(channel: amqp.Channel):
    ...
    channel.basic_consume("flows.update-project", callback=UpdateProjectConsumer().handle)
