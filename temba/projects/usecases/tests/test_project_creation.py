...
class ProjectCreationUseCaseTest(TembaTest):
    ...
    def test_create_project_creates_default_wwc_channel(self, mock_update_project):
        ...
        self.assertEqual(channel.name, "Weni Web Chat")
    ...
    @patch("temba.projects.usecases.project_creation.ConnectInternalClient.update_project")
    def test_create_project_creates_new_wwc_channel_when_existing_lacks_preview(self, mock_update_project):
        project_uuid = uuid.uuid4()
        ...
        self.assertEqual(new_channel.name, "Weni Web Chat")
